...
string texte[n_str] = { "Connexion en cours au reseau universel",
                        ...
                        "Erreur : la variable 'respect' n'a pas ete trouvee",
                        ...
                        "Silo ne nous laisse pas la parole, ni le choix",
                        "tash fait un peu tache",
                        "JP Fuko",
                        "Ceux qui cherchent a se faire de la pub ou de la thune, dehors !",
                        "Re",
                        ...
                        "Passage en 1080p 60ips audio 48kHz non compresse",
